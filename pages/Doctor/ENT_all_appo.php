                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-footer">
                                ...
                                if (!$cn) {
                                    ...
                                    // $sql = "Select *From bookappoint where specialization = 'ENT' AND do_app_cancel='Pending' || do_app_cancel='Approve' AND us_app_cancel='Waiting'";
                                    $sql = "Select *From bookappoint where specialization = 'ENT'";
                                    $rs = $cn->query($sql);
                                    echo "<table>";
                                    echo "<tr>";
                                    echo "<th>ID</th>";
