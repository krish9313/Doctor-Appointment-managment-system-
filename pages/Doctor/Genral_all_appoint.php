        ...
        <aside class="sidebar navbar-default" role="navigation" style="margin-top:60px;">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li>
                        <a href="Doctor2.php" class="nav-link"><img src="..\icon\dashboard.png" width="20px"> &nbsp;
                            Dashboard</a>
                    </li>
                    <li>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-footer">
                                ...
                                if (!$cn) {
                                    ...
                                    // $sql = "Select *From bookappoint where specialization = 'General Surgery' AND do_app_cancel='Pending' || do_app_cancel='Approve' AND us_app_cancel='Waiting'";
                                    $sql = "Select *From bookappoint where specialization = 'General Surgery'";
                                    $rs = $cn->query($sql);
                                    echo "<table>";
                                    echo "<tr>";
                                    echo "<th>ID</th>";
