                    ...
                    <li>
                        ...
                        <div class="collapse" id="Appointment">
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="neew_appointment.php">New Appointment</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <?php
                                        ...
                                        $countSql = "SELECT COUNT(*) AS count FROM bookappoint where specialization='ENT'";
                        ...
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <?php
                                        include('connection.php');
                                        $countSql = "SELECT COUNT(*) AS count FROM bookappoint where specialization='ENT' && app_date IS NULL";
                                        $countResult = $cn->query($countSql);
                                        $countRow = $countResult->fetch_assoc();
                                        $count = $countRow['count'];
