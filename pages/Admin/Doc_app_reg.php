                            ...
                            <div class="panel-footer" style="height: 100%;">
                                ...
                                if (!$cn) {
                                    ...
                                    while ($r = $rs->fetch_assoc()) {
                                        ...
                                        echo "<td>" . "<a href='App_proc.php?ID=$r[id]'><button class='btn btn-primary'>Approve</button></a>" . "</td>";

                                        echo "<td>" . "<a href='Rej_pro.php?ID=$r[id]'><button class='btn btn-danger'>Reject</button></a>" . "</td>";
                                        echo "</tr>";
                                    }
